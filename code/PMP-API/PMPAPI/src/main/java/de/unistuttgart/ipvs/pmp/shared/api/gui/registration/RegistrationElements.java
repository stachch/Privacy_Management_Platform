...
class RegistrationElements {
    ...
    private void fillRegistrationStateList() {
        this.registrationStateList.add(new RegistrationStateListItem(this.parentUi.getContext(), 1,
                this.parentUi.getContext().getString(R.string.pmp_api_registration_step_1)));
        this.registrationStateList.add(new RegistrationStateListItem(this.parentUi.getContext(), 2,
                this.parentUi.getContext().getString(R.string.pmp_api_registration_step_2)));
        this.registrationStateList.add(new RegistrationStateListItem(this.parentUi.getContext(), 3,
                this.parentUi.getContext().getString(R.string.pmp_api_registration_step_3)));
        this.registrationStateList.add(new RegistrationStateListItem(this.parentUi.getContext(), 4,
                this.parentUi.getContext().getString(R.string.pmp_api_registration_step_4)));
        this.registrationStateList.add(new RegistrationStateListItem(this.parentUi.getContext(), 5,
                this.parentUi.getContext().getString(R.string.pmp_api_registration_step_5)));
